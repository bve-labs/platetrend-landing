 ...
 */
export async function scrapeGoogleReviews(restaurantName: string): Promise<ScrapedReview[]> {
 ...
 */
export async function scrapeYelpReviews(restaurantName: string): Promise<ScrapedReview[]> {
  const mockReviews: ScrapedReview[] = [
    {
